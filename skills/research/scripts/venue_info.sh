#!/bin/bash
# Venue quality summary — CCF rank + impact factor + quartile
# Usage: bash scripts/venue_info.sh "venue_name"
...
CCF_DB="$SKILL_DATA_DIR/ccf_2026.sqlite"
IF_DB="$SKILL_DATA_DIR/impact_factor.sqlite3"
